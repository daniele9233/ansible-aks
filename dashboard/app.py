...
COMMANDS = {
    ...
    'dryrun_all':             {'exe': 'ansible-playbook', 'args': ['site.yml', '--tags', 'rancher_ca_valid,aks_static_pv,pgadmin', '--check', '--diff'], 'needs_vault': True},
    ...
    'deploy_all':             {'exe': 'ansible-playbook', 'args': ['site.yml', '--tags', 'rancher_ca_valid,aks_static_pv,pgadmin'],              'needs_vault': True},
